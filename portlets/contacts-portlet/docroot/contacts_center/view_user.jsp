									...
									<c:choose>
										<c:when test="<%= !results.isEmpty() %>">
											...
											%>
												...
												<li class="user-information-sites <%= SocialOfficeServiceUtil.isSocialOfficeGroup(curGroup.getGroupId()) ? "social-office-enabled" : "social-office-disabled" %>"><a href="<%= curGroup.getDisplayURL(themeDisplay) %>"><%= HtmlUtil.escape(curGroup.getDescriptiveName(locale)) %></a></li>
