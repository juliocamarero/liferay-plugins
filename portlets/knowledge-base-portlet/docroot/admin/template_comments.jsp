...
<c:if test="<%= (enableKBTemplateKBComments && themeDisplay.isSignedIn()) || showKBTemplateKBComments %>">
	...
	<aui:script>
		function <portlet:namespace />deleteKBComment(kbCommentId) {
			...
			submitForm(document.<portlet:namespace />fm, "<liferay-portlet:actionURL name="deleteKBComment"><portlet:param name="mvcPath" value='<%= jspPath + "view_template.jsp" %>' /><portlet:param name="redirect" value="<%= redirect %>" /><portlet:param name="kbTemplateId" value="<%= String.valueOf(kbTemplate.getKbTemplateId()) %>" /></liferay-portlet:actionURL>");
		}
		...
		function <portlet:namespace />updateKBComment() {
			...
			submitForm(document.<portlet:namespace />fm, "<liferay-portlet:actionURL name="updateKBComment"><portlet:param name="mvcPath" value='<%= jspPath + "view_template.jsp" %>' /><portlet:param name="redirect" value="<%= redirect %>" /><portlet:param name="kbTemplateId" value="<%= String.valueOf(kbTemplate.getKbTemplateId()) %>" /></liferay-portlet:actionURL>");
		}
	</aui:script>
</c:if>